...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize the buttons - TR
        Button scoreButton = (Button) findViewById(R.id.button_score);
        Button closebyButton = (Button) findViewById(R.id.buton_closeby);
    ...
    public void showScore(View view) {
        ...
        startActivityForResult(new Intent(this, ScorePopActivity.class), REQUEST_CONNECT_DEVICE_SECURE);

    }

    // Who's Close button - TR
    public void whosClose(View view) {

        startActivityForResult(new Intent(this, ClosePopActivity.class), REQUEST_CONNECT_DEVICE_SECURE);

    }

    // My Activity button - TR
    public void showActivity(View view) {

        startActivityForResult(new Intent(this, ActivityPopActivity.class), REQUEST_CONNECT_DEVICE_SECURE);
